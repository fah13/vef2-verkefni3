...
VALUES
('Jón Jónsson', 'jon@example.org', 1231231, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut bibendum eleifend odio, eu laoreet sapien sollicitudin quis.', 'forritari');

INSERT INTO applications
(name, email, phone, text, job, processed)
VALUES
...
(name, email, phone, text, job)
VALUES
('Anna Önnudóttir', 'anna@example.org', 3333333, 'Sed in sem sagittis, fringilla justo eget, vulputate nunc. Cras pharetra faucibus blandit. Sed non porta ligula, non efficitur dolor.', 'forritari');
